...
// 签名证书路径
const SDK_SIGN_CERT_PATH = '/var/www/certs1/acp_test_sign.pfx';

// 签名证书密码
const SDK_SIGN_CERT_PWD = '000000';

// 密码加密证书（这条一般用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = 'e';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = '/var/www/certs1';
...
const SDK_BACK_NOTIFY_URL = 'http://www.517xc.com/Pay/Pay/yinlian';
