			...
			$.ajax({
		        ...
		        success: function(data) {
		           switch(data){
	           		...
	           		default:  alert("添加成功");
					//alert("<?php echo U('jxinfo');?>?userid="+data);
	           	    location.href="<?php echo U('jxinfo');?>?userid="+data;
	           	  }
		        }
			});
		});
...
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form1" name='form1'>
		<div class="row cl" >
				<input type="hidden" name="pass"   class="input-text" style="width:300px;" value="<?php echo ($pass); ?>">
