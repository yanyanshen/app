...
/**
 * An instance of the `vjs.Player` class is created when any of the Video.map setup methods are used to initialize a video.
 *
 * ```map
 * var myPlayer = videojs('example_video_1');
 * ```
 *
 * In the follwing example, the `data-setup` attribute tells the Video.map library to create a player instance when the library is ready.
 *
 * ```html
 ...
 * (Parse Method Only)
 * https://github.com/douglascrockford/JSON-map/blob/master/json2.map
