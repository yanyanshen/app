...
(function () {
	...
	var config = {
			 ...
			 * highcharts.map or highstock.map
			 */
	...
	mapCLArguments = function () {
		...
		if (system.args.length < 1) {
			console.log('Commandline Usage: highcharts-convert.map -infile URL -outfile filename -scale 2.5 -width 300 -constr Chart -callback callback.js');
